...
cameras::Intrinsic_Parameter_Type CheckIntrinsicParameterTypeStringValidity(
  ...
  std::unordered_map<int, cameras::Intrinsic_Parameter_Type> &opt_per_model)
{
  opt_per_model.clear();
...
int main(int argc, char **argv)
{
  ...
  std::unordered_map<int, cameras::Intrinsic_Parameter_Type> intrinsic_refinement_options_per_model;
