...
struct Optimize_Options
{
  ...
  std::unordered_map<int, cameras::Intrinsic_Parameter_Type> intrinsics_opt_per_model;
  ...
  (
    ...
    std::unordered_map<int, cameras::Intrinsic_Parameter_Type> intrinsics_per_model={}
  )
  :intrinsics_opt(intrinsics),
   ...
   intrinsics_opt_per_model(intrinsics_per_model)
  {
  }
};
